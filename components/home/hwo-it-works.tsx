...
const steps: Step[] = [
  ...
  },
  {
    ...
    label: "AI Analysis",
    description: "Our advance AI process and analyzes your docuemtn instantly.",
  },
  {
...
function StepItem({ icon, label, description }: Step) {
  return (
    <div className="relative p-6 rounded-2xl backdrop-blur-xs bg-white/10 border border-white/10 hover:border-rose-500/50 transition-colors group w-full">
